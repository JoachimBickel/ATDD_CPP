...
int main(int argc, char* argv[])
{
    ...
    window.viewport().setOrbitHandler([&service](const double yaw) { service.orbit(yaw); });
    window.viewport().setZoomHandler([&service](const double factor) { service.zoom(factor); });
